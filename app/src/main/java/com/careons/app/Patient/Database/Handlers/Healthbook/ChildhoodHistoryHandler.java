...
public class ChildhoodHistoryHandler
        implements DatePickerDialog.OnDateSetListener, View.OnClickListener {

    private Context context;
    private ChildhoodHistory childhoodHistory;
    ...
    // Constructor
    public ChildhoodHistoryHandler(final ChildhoodHistory childhoodHistory, final ViewDataBinding dataCard) {

        this.childhoodHistory = childhoodHistory;
        ...
        disp_comments.setVisibility(Validation.isEmpty(childhoodHistory.getComments()) ? View.GONE : View.VISIBLE);
                    ...
                    case R.id.action_delete:
                        ...
                        acceptCardView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                // Call Delete API
                                ChildhoodFragment.deleteChildhoodHistory(context, String.valueOf(childhoodHistory.getpId()));
                                dialog.dismiss();
                            }
                        });
    ...
    public void save(View view) {
        ...
        if (Validation.validateStartDate(startDateTextView, dataCard.getRoot().getContext())) {
            ...
            updatedDataObject.put(StringConstants.KEY_PROBLEMS_ID, childhoodHistory.getProblemId());
            ...
            List<ChildhoodHistory> childhoodHistoryDBList =
                    ChildhoodHistory.find(ChildhoodHistory.class, "patient_id = ? and problem_id = ?",
                            SharedPreferenceService.getValue(context, StringConstants.KEY_PATIENT_ID),
                            childhoodHistory.getProblemId());

            if (childhoodHistoryDBList.size() > 0) {

                // Found -> Update Record
                updatedDataObject.put(StringConstants.KEY_P_ID, childhoodHistory.getpId());
                ChildhoodFragment.updateChildhoodHistory(context, updatedDataObject);

            } else {

                // Not Found -> Create Record
                ChildhoodFragment.createChildhoodHistory(context, updatedDataObject);
            }
        }
    }
    ...
    public void openDatePicker() {
        ...
        dpd.show(ChildhoodFragment.getInstance().getActivity().getFragmentManager(), StringConstants.KEY_DATEPICKER_DIALOG);
        //dpd.setAccentColor(R.color.ch);
