...
public class SurgicalHistory extends SugarRecord {
    ...
    public SurgicalHistory(String patientId, String pId, String problemId,
                           String problemName, String hyperlink,
                           String category, String startDate, boolean isStillSuffering,
