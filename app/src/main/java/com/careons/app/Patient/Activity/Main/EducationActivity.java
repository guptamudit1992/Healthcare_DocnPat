...
public class EducationActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        emptyRecyclerView = (LinearLayout) findViewById(R.id.hs_problems_empty);
        dataRecycelerView = (LinearLayout) findViewById(R.id.hs_problems);
        emptyHSCta = (TextView) findViewById(R.id.empty_hs_cta);
        emptyHSCta.setOnClickListener(this);
        searchBarContainer = (EditText) findViewById(R.id.search_bar_field);
        searchBarContainer.setFocusable(false);
        searchBarContainer.setOnClickListener(this);
        hsProblemListRecyclerView = (RecyclerView) findViewById(R.id.hs_recycler_view);

        // Fetch problems, medications and allergies
        readHeathSearchList(getApplicationContext());
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.empty_hs_cta:
                intent = new Intent(getApplicationContext(), HealthbookActivity.class);
    ...
    public void readHeathSearchList(final Context context) {
         ...
         */
        if(SharedPreferenceService.getValue(getApplicationContext(), StringConstants.KEY_GENDER).equalsIgnoreCase(getString(R.string.female))) {
